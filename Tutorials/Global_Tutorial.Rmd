---
title: "Global Tutorial for GOALS"
...
explain a fixed $H^2\%$ (phenotypic variance explained; PVE) of the total variance in the 
response $V(y)$. This parameter $H^2$ can alternatively be described as a factor controlling the 
signal-to-noise ratio. The parameter $\rho$ represents the proportion of $H^2$ that is contributed by additive effects versus interaction effects. 
...
Find the Approximate Basis and Kernel Matrix; Choose $N \leq D \leq P$. 
